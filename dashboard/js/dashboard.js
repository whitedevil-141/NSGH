...
async function loadDoctors() {
    try {
        const res = await fetch('https://www.api.nsghbd.com/public/doctors/data');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    addForm.addEventListener('submit', async e => {
        ...
        try {
            const res = await fetch('https://www.api.nsghbd.com/doctors/add', {
                method: 'POST',
...
document.getElementById('editDoctorForm').addEventListener('submit', async e => {
    ...
    try {
        const res = await fetch(`https://www.api.nsghbd.com/doctors/update/${id}`, {
            method: 'PUT',
            headers: { 'Authorization': `Bearer ${token}` },
            body: formData
        });
...
async function deleteDoctor(id) {
    ...
    try {
        await fetch(`https://www.api.nsghbd.com/doctors/${id}`, {
            method: 'DELETE',
            headers: { 'Authorization': `Bearer ${token}` }
        });
        alert("Deleted");
